...
console.log("Hello Word! Abby is the most awesome person ever!!!!!!!");
...
document.getElementById("column1").innerHTML =
  "<h3>BAZINGAA<h3> <p>YIPPIE YAY YIPPIE YO!!!!!!!!!!!<p>";
//*= means to add it to what is already there
document.getElementById("column1").innerHTML += "<p>I AM A GENIUS</p>";
document.getElementById("column1").innerHTML +=
...
document.getElementById("column2").style.fontSize = "45pt";
document.getElementById("column2").style.backgroundColor = "black";
//LOGIC!
...
//then change the inner html of column to say "<p> you are using fists</p>"
//else if the weapon equals cat
//then give a diffrent message
//otherwize(else)
//then give a diffrent message
//if(){} else if (){} else{}
if (weapon == "fists") {
  ...
  document.getElementById("column3").innerHTML += "<p>SCRATCH ATTACK</p>";
} else {
  document.getElementById("column3").innerHTML +=
    "<p>Your weapon doesn't work here!</p>";
}
...
console.log(damage);
//chn=ange the content in the third column
document.getElementById("column3").innerHTML +=
