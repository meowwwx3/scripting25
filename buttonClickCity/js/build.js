...
function apartBuild() {
  ...
  document.getElementById("city").innerHTML =
    "You have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock2.png' alt='Storage Unit'>";
}
...
function schoolBuild() {
  ...
  document.getElementById("city").innerHTML =
    "You have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock3.png' alt='School'>";
}

//4th button
function skyBuild() {
  console.log("Skyscraper is working!");
  buildings++;
  document.getElementById("city").innerHTML =
    "You have " + buildings + " buildings in your city!";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock4.png' alt='Skyscaper'>";
}
